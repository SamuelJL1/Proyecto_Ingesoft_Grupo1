...
*RF:* El sistema debe organizar la información de cada electiva en secciones definidas (objetivos, contenido, profesor, departamento).  
...
*RF:* El sistema debe permitir el acceso rápido a la información principal de cada electiva.  
